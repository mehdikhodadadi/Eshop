...
namespace IdentityMicroservice.UnitTests
{
    public class IdentityControllerTest
    {
        ...
        {
            new User{ Id = new Guid("b4f431d7-2653-4ec9-a34c-d4035e74c663"), Email= "user@mail.com", Password = "tabSdQLDL9r29Mek9PvWnw9kM61CT3klw0pOZBQhAskqW11/4zpEpA==", Salt = "BCHatrzmOgciBaIW/DjLgw/lCCbBNNWxGvL1C25mZHaxgTBAfolOVA==", IsAdmin= false},
            new User{ Id = new Guid("0228f78e-1e6e-4929-9f2d-3986403ca84f"), Email= "admin@mail.com", Password = "tabSdQLDL9r29Mek9PvWnw9kM61CT3klw0pOZBQhAskqW11/4zpEpA==", Salt = "BCHatrzmOgciBaIW/DjLgw/lCCbBNNWxGvL1C25mZHaxgTBAfolOVA==", IsAdmin= true}
        };
        ...
        {
            var user = new User { Email = "user@mail.com", Password = "pass" };
            ...
            var user2 = new User { Email = "user2@mail.com", Password = "pass" };
            ...
            user.Password = "pass";
            okObjectResult = _controller.Login(user, "admin");
            Assert.IsType<BadRequestObjectResult>(okObjectResult.Result);
            var admin = new User { Email = "admin@mail.com", Password = "pass" };
            okObjectResult = _controller.Login(admin, "admin");
        ...
        {
            var user = new User { Email = "user@email.com", Password = "pass" };
            var okResult = _controller.Register(user);
            Assert.IsType<OkResult>(okResult);
            okResult = _controller.Register(new User { Email = "user@email.com", Password = "pass" });
        ...
        public void ValidateTest()
        {
            ...
            okObjectResult = _controller.Validate("user2@mail.com", token);
            Assert.IsType<NotFoundObjectResult>(okObjectResult.Result);
